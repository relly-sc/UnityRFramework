...
namespace UnityRFramework.Runtime
{
    ...
    public sealed class ProcedureComponent : UnityRFrameworkComponent
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                return m_ProcedureModule.CurrentProcedure;
            }
        }
        ...
        public float CurrentProcedureTime
        {
            get
            {
                return m_ProcedureModule.CurrentProcedureTime;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            m_ProcedureModule = RFrameworkModuleEntry.GetModule<IProcedureModule>();
            if (m_ProcedureModule == null)
            {
                Log.Fatal("Procedure module is invalid.");
                return;
            }
        }
        ...
        private IEnumerator Start()
        {
            ...
            m_ProcedureModule.Initialize(RFrameworkModuleEntry.GetModule<IFsmModule>(), procedures);

            yield return new WaitForEndOfFrame();

            m_ProcedureModule.StartProcedure(m_EntranceProcedure.GetType());
        }
