...
namespace UnityRFramework.Runtime
{
    ...
    [AddComponentMenu("UnityRFramework/Object Pool")]
    public sealed class ObjectPoolComponent : UnityRFrameworkComponent
    {
        private IObjectPoolModule m_IObjectPoolModule = null;
        ...
        public int Count
        {
            get
            {
                return m_IObjectPoolModule.Count;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            m_IObjectPoolModule = RFrameworkModuleEntry.GetModule<IObjectPoolModule>();
            if (m_IObjectPoolModule == null)
            {
                Log.Fatal("Object pool module is invalid.");
                return;
            }
        }
        ...
        {
            return m_IObjectPoolModule.HasObjectPool<T>();
        }
        ...
        {
            return m_IObjectPoolModule.HasObjectPool(objectType);
        }
        ...
        {
            return m_IObjectPoolModule.HasObjectPool<T>(name);
        }
        ...
        {
            return m_IObjectPoolModule.HasObjectPool(objectType, name);
        }
        ...
        {
            return m_IObjectPoolModule.HasObjectPool(condition);
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPool<T>();
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPool(objectType);
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPool<T>(name);
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPool(objectType, name);
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPool(condition);
        }
        ...
        {
            return m_IObjectPoolModule.GetObjectPools(condition);
        }
        ...
        {
            m_IObjectPoolModule.GetObjectPools(condition, results);
        }
        ...
        {
            return m_IObjectPoolModule.GetAllObjectPools();
        }
        ...
        {
            m_IObjectPoolModule.GetAllObjectPools(results);
        }
        ...
        {
            return m_IObjectPoolModule.GetAllObjectPools(sort);
        }
        ...
        {
            m_IObjectPoolModule.GetAllObjectPools(sort, results);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>();
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool<T>(name, autoReleaseInterval, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateSingleSpawnObjectPool(objectType, name, autoReleaseInterval, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>();
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, capacity);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, capacity, expireTime);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, capacity, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool<T>(name, autoReleaseInterval, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.CreateMultiSpawnObjectPool(objectType, name, autoReleaseInterval, capacity, expireTime, priority);
        }
        ...
        {
            return m_IObjectPoolModule.DestroyObjectPool<T>();
        }
        ...
        {
            return m_IObjectPoolModule.DestroyObjectPool(objectType);
        }
        ...
        {
            return m_IObjectPoolModule.DestroyObjectPool<T>(name);
        }
        ...
        {
            return m_IObjectPoolModule.DestroyObjectPool(objectType, name);
        }
        ...
        {
            return m_IObjectPoolModule.DestroyObjectPool(objectPool);
        }
        ...
        public void ReleaseAllUnused()
        {
            ...
            m_IObjectPoolModule.ReleaseAllUnused();
        }
    }
}
